      ...
      <AnimatePresence>
        {isVisible && (
          ...
          >
            <div
              ref={contentRef}
              className="text-[13px] w-[160px] leading-relaxed text-neutral-700 dark:text-neutral-300 [&_img]:max-w-[300px] [&_img]:h-auto [&_img]:bg-transparent [&_img]:block [&_img]:relative [&_img]:z-10 [&_img]:mb-0 [&_span]:!opacity-100 [&_span>img]:!opacity-100 [&>p]:mb-2 [&>p]:last:mb-0 [&>p]:leading-relaxed [&>*+*]:mt-2"
            >
              {content}
            </div>
          </motion.div>
