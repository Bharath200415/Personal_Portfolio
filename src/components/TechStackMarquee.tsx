...
const techStack = [
  ...
  { name: "CloudFlare", category: "tool", icon: "/tech-icons/cloudflare.svg", color: "bg-gray-500" },
...
export default function TechStackMarquee({ className = "" }: TechStackMarqueeProps) {
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="mb-4">
        <h2 className="text-base font-[family-name:var(--font-instrument-serif)] sm:text-xl mb-3 opacity-40 mt-4 sm:mt-6 -tracking-[0.01em]">
          Stack I use
        </h2>
